...
import ClazzCourseSearch from "../../../components/Search/ClazzCourseSearch";
import {ManagePaginationProps} from "../../../components/Table";
import ClazzCourseService, {ClazzCourseModel, defaultClazzCourse} from "../../../services/ClazzCourseService";
import {PageInfo} from "../../../services/service";
import {message} from "antd";
import {ClazzBatchSelectCourseDialog, ClazzSelectedCourseDialog} from "./ClazzCourseModal";
import {ClazzUnSelectedCourseTable} from "../../../components/Table/ClazzCourseTable";

/*
 * @class ClazzCourseState
 * @description 教师管理课程的state
 * @author 戴俊明 <idaijunming@163.com>
 * @date 2019/8/10 18:55
 **/
export interface ClazzCourseState {
	/*
	 * @var 教师id
	 * @author 戴俊明 <idaijunming@163.com>
	 ...
	 **/
	search: Partial<ClazzCourseModel>,
	/*
	 * @var 批量选择的模态框提示是否显示
	 * @author 戴俊明 <idaijunming@163.com>
	 ...
	 * @date 2019/8/10 19:02
	 **/
	selectedData: Array<ClazzCourseModel>,
	/*
	 * @var 将要从已选择课程中删除的课程
	 * @author 戴俊明 <idaijunming@163.com>
	 * @date 2019/8/10 19:03
	 **/
	unSelectedRows: Array<ClazzCourseModel>
	/*
	 * @var 未选择的课程
	 * @author 戴俊明 <idaijunming@163.com>
	 * @date 2019/8/10 19:03
	 **/
	unSelectedData: Array<ClazzCourseModel>,
	/*
	 * @var 将要选择的课程
	 * @author 戴俊明 <idaijunming@163.com>
	 * @date 2019/8/10 19:04
	 **/
	selectedRows: Array<ClazzCourseModel>,
	/*
	 * @var 未选择课程的分页参数
	 * @author 戴俊明 <idaijunming@163.com>
	 * @date 2019/8/10 19:04
 ...
 **/
class ClazzCourse extends React.Component<{}, ClazzCourseState> {

	state: ClazzCourseState = {
		id: 0,
		search: defaultClazzCourse,
	...
	handleSearchCommand = (id: number, search: Partial<ClazzCourseModel>) => {
		/*
	...
	handleUnSelectedCourseSelect = (record: ClazzCourseModel) => {
		/*
	...
	handleUnSelectedCourseBatchSelect = (records: ClazzCourseModel[]) => {
		/*
		 ...
		 **/
		ClazzCourseService.batchChoose(records.map(course => ({
			zid: this.state.id,
	...
	handleUnSelectedTableSelectionChange = (selectedRowKeys: number[], selectedRows: ClazzCourseModel[]) => {
		/*
	...
	handleSelectedCourseDrop = (records: ClazzCourseModel[]) => {
		/*
		...
		ClazzCourseService.batchDrop(records.map(course => ({
			zid: this.state.id,
			cid: course.cid as number,
	...
	render() {
		return (
			<div>
				<ClazzCourseSearch id={this.state.id}
				...
				/>
				<ClazzUnSelectedCourseTable dataSource={this.state.unSelectedData}
				...
				/>
				<ClazzBatchSelectCourseDialog record={this.state.selectedRows}
				...
				<ClazzSelectedCourseDialog dataSource={this.state.selectedData}
	...
	getData = (id: number, search: Partial<ClazzCourseModel>, pageNum: number, pageSize: number) => {
		/*
		 * @method getData
		 * @param id 教师id
		 * @param search 搜索结果
